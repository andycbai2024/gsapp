(() => {
  ...
  var deleteSelection, joinBackward, joinTextblockBackward, joinTextblockForward, selectNodeBackward, joinForward, selectNodeForward, joinUp, joinDown, lift2, newlineInCode, exitCode, createParagraphNear, liftEmptyBlock, splitBlock, selectParentNode, selectAll, selectTextblockStart, selectTextblockEnd, backspace, del, pcBaseKeymap, macBaseKeymap, mac;
  ...
  var init_dist7 = __esm({
    "node_modules/prosemirror-view/dist/index.js"() {
      ...
      selectNodeModifier = mac2 ? "metaKey" : "ctrlKey";
      ...
      dragCopyModifier = mac2 ? "altKey" : "ctrlKey";
...
${indentedChild}`;
  ...
  var init_dist9 = __esm({
    "node_modules/@tiptap/core/dist/index.js"() {
      ...
      expandSelectionForSide = ($pos, schema, side) => {
      ...
      expandSelectionForInlineText = ($from, $to, schema) => {
      ...
      focus = (position = null, options = {}) => ({ editor, view, tr: tr2, dispatch }) => {
        options = {
          scrollIntoView: true,
          ...options
        };
      ...
      insertContentAt = (position, value, options) => ({ tr: tr2, dispatch, editor }) => {
        var _a;
        if (dispatch) {
          options = {
      ...
      joinItemBackward = () => ({ state, dispatch, tr: tr2 }) => {
        try {
      ...
      joinTextblockBackward2 = () => ({ state, dispatch }) => {
        return joinTextblockBackward(state, dispatch);
      };
      joinTextblockForward2 = () => ({ state, dispatch }) => {
        return joinTextblockForward(state, dispatch);
      };
      keyboardShortcut = (name) => ({ editor, view, tr: tr2, dispatch }) => {
      ...
      setContent = (content, { errorOnInvalidContent, emitUpdate = true, parseOptions = {} } = {}) => ({ editor, tr: tr2, dispatch, commands }) => {
        const { doc: doc3 } = tr2;
      ...
      MappablePosition = class _MappablePosition {
      ...
      setTextDirection = (direction, position) => ({ tr: tr2, state, dispatch }) => {
        const { selection } = state;
        let from2;
        let to;
      ...
      splitListItem = (typeOrName, overrideAttrs = {}) => ({ tr: tr2, state, dispatch, editor }) => {
        var _a;
        const type = getNodeType(typeOrName, state.schema);
        const { $from, $to } = state.selection;
      ...
      toggleList = (listTypeOrName, itemTypeOrName, keepMarks, attributes = {}) => ({ editor, tr: tr2, state, dispatch, chain, commands, can }) => {
      ...
      unsetMark = (typeOrName, options = {}) => ({ tr: tr2, state, dispatch }) => {
        var _a;
        const { extendEmptyMarkRange = false } = options;
        const { selection } = tr2;
        const type = getMarkType(typeOrName, state.schema);
      ...
      unsetTextDirection = (position) => ({ tr: tr2, state, dispatch }) => {
        const { selection } = state;
        let from2;
        let to;
        if (typeof position === "number") {
      ...
      Mark2 = class _Mark extends Extendable {
        constructor() {
          super(...arguments);
          this.type = "mark";
        }
...
.ProseMirror-focused .ProseMirror-gapcursor {
  ...
  var handleBackspace, inputRegex, Blockquote;
  var init_dist10 = __esm({
    "node_modules/@tiptap/extension-blockquote/dist/index.js"() {
      init_dist9();
      init_state();
      init_jsx_runtime2();
      handleBackspace = (editor, type) => {
        var _a;
...
`);
  ...
  var inputRegexMatch, pasteRegexMatch, Code;
  ...
  var DEFAULT_TAB_SIZE, backtickInputRegex, tildeInputRegex, CodeBlock;
...
`,
  ...
  var init_dist18 = __esm({
    "node_modules/@tiptap/extension-italic/dist/index.js"() {
      ...
      underscoreInputRegex2 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/;
      underscorePasteRegex2 = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g;
      Italic = Mark2.create({
        name: "italic",
        addOptions() {
          return {
...
3. "-" cannot repeat`);
  ...
  var encodedTlds, encodedUtlds, numeric, ascii, alpha, asciinumeric, alphanumeric, domain, emoji, scheme, slashscheme, whitespace, ta, tr, ts, tt, WORD, UWORD, ASCIINUMERICAL, ALPHANUMERICAL, LOCALHOST, TLD, UTLD, SCHEME, SLASH_SCHEME, NUM, WS, NL, OPENBRACE, CLOSEBRACE, OPENBRACKET, CLOSEBRACKET, OPENPAREN, CLOSEPAREN, OPENANGLEBRACKET, CLOSEANGLEBRACKET, FULLWIDTHLEFTPAREN, FULLWIDTHRIGHTPAREN, LEFTCORNERBRACKET, RIGHTCORNERBRACKET, LEFTWHITECORNERBRACKET, RIGHTWHITECORNERBRACKET, FULLWIDTHLESSTHAN, FULLWIDTHGREATERTHAN, AMPERSAND, APOSTROPHE, ASTERISK, AT, BACKSLASH, BACKTICK, CARET, COLON, COMMA, DOLLAR, DOT, EQUALS, EXCLAMATION, HYPHEN, PERCENT, PIPE, PLUS, POUND, QUERY, QUOTE, FULLWIDTHMIDDLEDOT, SEMI, SLASH, TILDE, UNDERSCORE, EMOJI$1, SYM, tk, ASCII_LETTER, LETTER, EMOJI, DIGIT, SPACE, CR, LF, EMOJI_VARIATION, EMOJI_JOINER, OBJECT_REPLACEMENT, tlds, utlds, defaults, Email, Text, Nl, Url, makeState, warn, warnAdvice, INIT;
  var init_linkify = __esm({
    "node_modules/linkifyjs/dist/linkify.mjs"() {
      encodedTlds = "\xF6";
  ...
  var UNICODE_WHITESPACE_PATTERN, UNICODE_WHITESPACE_REGEX, UNICODE_WHITESPACE_REGEX_END, UNICODE_WHITESPACE_REGEX_GLOBAL, MARKDOWN_LINK_INPUT_REGEX, MARKDOWN_LINK_PASTE_REGEX, Link;
  var init_dist19 = __esm({
    "node_modules/@tiptap/extension-link/dist/index.js"() {
      ...
      UNICODE_WHITESPACE_REGEX_END = new RegExp(`${UNICODE_WHITESPACE_PATTERN}$`);
      UNICODE_WHITESPACE_REGEX_GLOBAL = new RegExp(UNICODE_WHITESPACE_PATTERN, "g");
      MARKDOWN_LINK_INPUT_REGEX = /\[([^[\]]+)\]\(((?:[^\s()]|\([^\s()]*\))+)(?:\s+(?:(["'])(.*?)\3|“(.*?)”|‘(.*?)’))?\)$/;
      MARKDOWN_LINK_PASTE_REGEX = /\[([^[\]]+)\]\(((?:[^\s()]|\([^\s()]*\))+)(?:\s+(?:(["'])(.*?)\3|“(.*?)”|‘(.*?)’))?\)/g;
      Link = Mark2.create({
        name: "link",
        priority: 1e3,
        keepOnSplit: false,
  ...
  var __defProp2, __export2, ListItemName, TextStyleName, bulletListInputRegex, BulletList, getBranchingNestedListAtCursor, hoistBranchingNestedList, handleDeleteBranchingNestedList, createBranchingListDeleteKeymap, ROMAN_NUMERALS, ALPHA_NUMERALS, ORDERED_LIST_ALPHA_MARKER_PATTERN, ORDERED_LIST_MARKER_PATTERN, ListItem, listHelpers_exports, findListItemPos, getNextListDepth, hasListBefore, handleBackspace2, nextListIsDeeper, nextListIsHigher, handleDelete, hasListItemAfter, hasListItemBefore, listItemHasSubList, ListKeymap, ORDERED_LIST_ITEM_REGEX, INDENTED_LINE_REGEX, PARAGRAPH_INTERRUPTERS, PLAIN_TEXT_ORDERED_LIST_LINE_REGEX, ListItemName2, TextStyleName2, orderedListInputRegex, OrderedList, inputRegex2, TaskItem, TaskList, ListKit;
  var init_dist20 = __esm({
    "node_modules/@tiptap/extension-list/dist/index.js"() {
      ...
      getBranchingNestedListAtCursor = (state, itemName, wrapperNames) => {
        const { selection } = state;
        if (!selection.empty) {
          return null;
        }
      ...
      hoistBranchingNestedList = (state, dispatch, itemName, wrapperNames) => {
      ...
      handleDeleteBranchingNestedList = (editor, itemName, wrapperNames) => {
        return hoistBranchingNestedList(editor.state, editor.view.dispatch, itemName, wrapperNames);
      };
      createBranchingListDeleteKeymap = (itemName, wrapperNames) => {
      ...
      ALPHA_NUMERALS = "abcdefghijklmnopqrstuvwxyz";
      ORDERED_LIST_ALPHA_MARKER_PATTERN = "[a-zA-Z]{1,2}";
      ORDERED_LIST_MARKER_PATTERN = String.raw`\d+|[ivxlcdmIVXLCDM]+|${ORDERED_LIST_ALPHA_MARKER_PATTERN}`;
      ...
      handleBackspace2 = (editor, name, parentListTypes) => {
      ...
      ORDERED_LIST_ITEM_REGEX = new RegExp(
      ...
      PLAIN_TEXT_ORDERED_LIST_LINE_REGEX = new RegExp(
  ...
  var EMPTY_PARAGRAPH_MARKDOWN, NBSP_CHAR, Paragraph;
  ...
  var inputRegex3, pasteRegex, Strike;
  ...
  var CharacterCount, Dropcursor, Focus, Gapcursor, DEFAULT_DATA_ATTRIBUTE, PLUGIN_KEY, Placeholder, Selection2, skipTrailingNodeMeta, TrailingNode, UndoRedo;
  var init_dist29 = __esm({
    "node_modules/@tiptap/extensions/dist/index.js"() {
      ...
      init_dist9();
      init_history();
      CharacterCount = Extension.create({
        name: "characterCount",
        addOptions() {
          return {
            limit: null,
      ...
      DEFAULT_DATA_ATTRIBUTE = "placeholder";
      PLUGIN_KEY = new PluginKey("tiptap__placeholder");
      ...
      skipTrailingNodeMeta = "skipTrailingNode";
      TrailingNode = Extension.create({
        name: "trailingNode",
        addOptions() {
          return {
            node: void 0,
  ...
  var init_dist30 = __esm({
    "node_modules/@tiptap/starter-kit/dist/index.js"() {
      ...
      index_default = StarterKit;
    }
  });

  // tiptap-editor-source.js
  var require_tiptap_editor_source = __commonJS({
    "tiptap-editor-source.js"() {
      init_dist9();
      init_dist30();
      init_state();
      var QALine = Node3.create({
        name: "qaLine",
        group: "block",
        content: "inline*",
        defining: true,
        ...
        addKeyboardShortcuts() {
          return {
            Enter: () => {
              ...
              if (nextPosition === void 0 || nextPosition === fieldPosition) return true;
      ...
      window.StreamUiTiptap = function mountTranscriptEditor(element, content, editable, onUpdate) {
        return new Editor({
          element,
          extensions: [index_default, QALine, InputField],
          content,
          editable,
